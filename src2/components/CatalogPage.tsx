...
const CatalogPage: FC = () => {
    ...
    const [equipments, setEquipment] = useState<chemistryEquipment[]>([]);
    ...
    const breadcrumbsItems = [
        { label: 'Каталог', link: '' } // Ссылка на текущую страницу
    ];
                ...
                <div className="row">
                    ...
                    {equipments.map((chemistryEquipment) => (
                        <div className="col-4" key={chemistryEquipment.chemistry_product_id}>
                            <div className="card">
                                <img
                                    src={(chemistryEquipment.image_url_after_serializer != '' && chemistryEquipment.image_url_after_serializer !== 'http://localhost:9000/images/images/None') ? chemistryEquipment.image_url_after_serializer : logoImage}
                                ...
                                <div className="card-body">
                                    ...
                                    <a href={`/EquipmentDetail/${chemistryEquipment.chemistry_product_id}/`} className="btn btn-primary" style={{ height: '40px' }}>
                                        Подробнее
                                    </a>
